 ...
 *   id          stable string id
 *   nameZh      中文名
 *   nameEn      English name (used as fallback)
 *   muscles     primary muscle groups (Chinese tags shown in UI)
 *   muscleKeys  internal keys: chest|back|shoulders|biceps|triceps|quads|hamstrings|glutes|calves|core
 *   venues      which venues this exercise fits: gym | home_dumbbell | home_bodyweight
 *   isCompound  multi-joint compound? (used to prioritize for fullbody days)
 *   tips        2-3 short cues
 *   imageUrl    null for now (reserved for future)
 */
(function (global) {
  const EXERCISES = [
    // ===== 胸 chest =====
    ...
    },
    {
      ...
      venues: ['gym', 'home_dumbbell'], isCompound: true,
    ...
    },
    {
      ...
      venues: ['gym', 'home_dumbbell'], isCompound: false,
    ...
    },
    {
      ...
      venues: ['gym', 'home_dumbbell', 'home_bodyweight'], isCompound: true,
    ...
    },
    {
      ...
      muscles: ['上胸', '前束'], muscleKeys: ['chest', 'shoulders'],
      venues: ['home_bodyweight', 'home_dumbbell', 'gym'], isCompound: true,
    ...
    },
    {
      ...
      venues: ['home_bodyweight', 'gym'], isCompound: true,
    ...
    },
    {
      ...
      venues: ['home_bodyweight'], isCompound: true,
    ...
    },
    {
      ...
      venues: ['gym', 'home_dumbbell', 'home_bodyweight'], isCompound: false,
    ...
    },
    {
      ...
      venues: ['home_bodyweight', 'home_dumbbell', 'gym'], isCompound: false,
  ...
  global.ExerciseLib = {
    EXERCISES, byVenue, byMuscleKeys, byDayType, findById, TYPE_TO_MUSCLES,
  };
})(window);
